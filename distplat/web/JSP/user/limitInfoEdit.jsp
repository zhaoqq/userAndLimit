    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="box box-default">
                ...
                <!-- /.box-header -->
                <form role="form" action="doUpdateLimit.action" method = "post">
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-6">
                                <input type="hidden" name="limit.id" value="${Limit.id}" />
                                <div class="form-group">
                                    <label>权限名</label>

                                    <input type="text" class="form-control"name = "limit.name" placeholder="${Limit.name}">
                                </div>
                                <input type="hidden" name="limit.data.id" value="${Limit.data.id}" />
                                <input type="hidden" name="limit.algo.id" value="${Limit.algo.id}" />

                                <input type="hidden" name="limit.type" value="${Limit.type}" />

                                <div class="form-group">
                                    <label>权限描述</label>
                                    <textarea class="form-control" rows="3"name = "limit.comment" placeholder="${Limit.comment}"></textarea>
                                </div>
                                <div class="form-group">
                                    <label>可执行操作</label>
                                    <textarea class="form-control" name = "limit.limits" placeholder="${Limit.limits}"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="box-footer">
                        <div class="form-group">
                            <div class="pull-right">
                                <button type="submit" class="btn btn-primary" onclick="editConfirm()">修改</button>
