                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <div class="pull-right">
                                <a href="doShowAllAlgoData.action" class="btn btn-default btn-flat">添加权限</a>
                            </div>
                        ...
                        <div class="box-body">
                            <table class="table table-bordered table-hover" id="example2">
                                ...
                                <tbody>
                                <s:iterator value="#request.ALLLimit" id="Limit">
                                <tr>
                                    <td><s:property value="#Limit.id"/> </td>
                                    <td><s:property value="#Limit.name"/></td>
                                    <td><s:property value="#Limit.comment"/></td>
                                    <td>
                                        <a href="doQueryLimitById.action?id=<s:property value="#Limit.id"/>" type="button" class="btn btn-primary btn-flat btn-xs">编辑</a>
                                        <a href="<s:url action="doDeleteLimit" namespace="/"><s:param name="id" value="#Limit.id"/></s:url>"
                                           type="button" class="btn btn-primary btn-flat btn-xs" onclick="delConfirm()">删除</a>
                                    </td>
                                </tr>
                                </s:iterator>
                            ...
                            <div class="well">
                                <h4>权限信息备注</h4>
                                <p>权限信息包含有id, limitName（权限名）, comment（权限描述）</p>
                            </div>
                        </div>
