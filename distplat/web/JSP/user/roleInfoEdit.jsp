    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="box box-default">
                ...
                <!-- /.box-header -->
                <form role="form" action="doUpdateRole.action" method="post">
                    <div class="box-body" style="height:400px;">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label>角色描述</label>
                                    <input type="text" class="form-control"name="role.comment"  placeholder="${Role.comment}">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="box-footer">
                        <div class="form-group">
                            <div class="pull-right">
                                ...
                                <a href="${pageContext.request.contextPath}doShowAllRole.action" type="button" class="btn btn-default">返回</a>
                            </div>
                        </div>
                    </div>
                </form>
