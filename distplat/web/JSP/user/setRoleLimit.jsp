    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="box box-default">
                ...
                <!-- /.box-header -->
                <form role="form" action="doAllotLimits.action" method="post">
                    <row>
                        <input type="hidden" name="id" value="${requestScope.role_id}"/>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>角色名</label>
                                <input type="text" disabled="disabled" class="form-control" placeholder="${requestScope.RoleName}">
                            </div>
                        </div>
                        ...
                        <div class="panel-heading with-border">
                            <div class="col-md-6">
                                <h5 class="box-title" style="color: rgba(0,0,0,0.67)">备选权限</h5>
                            </div>
                            <div class="col-md-6">
                                <h5 class="box-title" style="color: rgba(0,0,0,0.67)">已选权限</h5>
                            </div>
                        </div>

                        <div class="panel-body panel-responsive">
                            <s:select list="#request.ALLLimits" listKey="id" listValue="name" value="#request.RoleLimits.{access.id}"
                                      name="roleLimit_ids" multiple="true" id = "test-select" cssClass="form-control select2"></s:select>
                        </div>
                        <div class="box-footer">
                            <div class="form-group">
                                <div class="pull-right">
                                    <button type="submit" class="btn btn-primary" onclick="return editConfirm()">确定</button>
                                    <a href="doShowAllRole.action" type="button" class="btn btn-default">返回</a>
                                </div>
                            </div>
                        </div>
                    </row>
