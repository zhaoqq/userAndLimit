            ...
            <div class="box-header">
              <div class="row">
                ...
                <div class="col-xs-7 pull-right">
                  <%--<a href="userInfoEdit.jsp" class="btn btn-default btn-flat pull-right">添加用户</a>--%>
            ...
            <div class="box-body">
              <table class="table table-bordered table-hover" id="example2">
                ...
                <tr>
                  ...
                  <td><s:property value="#User.comment"/></td>
                  <td>
                    <a href="doQueryById.action?id=<s:property value="#User.id"/>" type="button" class="btn btn-default btn-flat btn-xs">编辑</a>
                    <%--<button type="button" class="btn btn-default btn-xs" onclick="delConfirm()">删除</button>--%>
                    <a href="<s:url action ="doDeleteUser" namespace="/"><s:param name="id" value="#User.id"/>
                      </s:url>" type="button" class="btn btn-primary btn-flat btn-xs" onclick="return delConfirm()">删除</a>
                    <a href="doGrantRoles.action?id=<s:property value="#User.id"/>" type="button" class="btn  btn-default btn-flat btn-xs">编辑用户分组</a>
                  </td>
                </tr>
                </s:iterator>
                </tbody>
              ...
              <div class="well">
                <h4>用户信息备注</h4>
                <p>用户信息包含有id, userName（用户名）, password（密码）, level（等级：1~10）, email（邮箱）, comment（用户描述）</p>
              </div>
            </div>
          </div>
